...
const allowSpam: Module = {
  description: "Allow people to count multiple times in a row.",
...
const modules = { allowSpam, embed, recover, reposting, talking, webhook } as const;
