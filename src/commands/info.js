    ...
    embed: {
      ...
      fields: [
        ...
        },
        {
          name: "🌐 Links",
          value: [
            `**Invite me:** [https://discordapp.com/api/oauth2/authorize?...](https://discordapp.com/api/oauth2/authorize?client_id=${message.client.user.id}&permissions=805317648&scope=bot)`,
